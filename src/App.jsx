...
export default function PadelOS() {
  ...
  const editUser = (id, data) => {
    setUsers(us => us.map(u => u.id===id ? {...u, nickname:data.nickname, name:data.name, gov:data.gov, area:data.area, usr:data.usr, phone:data.phone, avatar:ini2(data.nickname)} : u));
